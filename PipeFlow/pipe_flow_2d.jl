...
# ==========================================================================================
# ==== Resolution
function run_pipe_flow(ps = 0.02, rn = 100, ss = 10, tend = 2.0, method = true)
    particle_spacing = ps
    ...
    sound_speed = ss * maximum(abs.(prescribed_velocity))
    ...
    return (sol=sol, semi=semi, fluid_system=fluid_system,
        open_boundary=open_boundary, boundary_system=boundary_system)
end
